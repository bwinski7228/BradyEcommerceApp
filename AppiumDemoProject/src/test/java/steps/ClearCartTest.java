...
public class ClearCartTest extends Capabilities {
	...
	public void clearCart() {
		//androidDriver.findElement(By.id("com.example.ecommerceapp:id/clear_cart_button"))
			//.click();
		androidDriver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.LinearLayout/android.widget.FrameLayout[1]/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.FrameLayout[2]/android.widget.Button"))
		.click();
	}
	...
	public void checkCart() {
		...
		this.retryingFindClick(By.xpath("/hierarchy/android.widget.Toast" +
		  "[contains(@text, 'Cart has been cleared')]"));
	}
